  ...
  return (
    ...
    >
      ...
      <div className="container" style={{ position: "relative", zIndex: 1 }}>
        ...
        >
          9 years crafting solutions at the intersection of AI and enterprise technology.
          Expert in AI agents, automation, Agile delivery, and stakeholder management
        ...
        >
          ...
          <a
            href="https://github.com/Radbert18o7"
            target="_blank"
            rel="noopener noreferrer"
            className="btn btn-outline"
            id="hero-github-btn"
